...
const Mercado: React.FC = () => {
  ...
  const data = [
    { indicadores: "Nº de projetos em andamento", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: 6,dez: 2, acumulado: 8 },
    { indicadores: "Nº de projetos - SESI EDUCAÇÃO", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: "-",dez: "-", acumulado: "-" },
    { indicadores: "Nº de projetos - SESI LAZER", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: 1,dez: "-", acumulado: 1},
    { indicadores: "Nº de projetos - SESI SAÚDE", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: 1 ,dez: 1, acumulado: 2 },
    { indicadores: "Nº de projetos - SESI SST", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: 2,dez: "-", acumulado: 2},
    { indicadores: "Nº de projetos - SENAI", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: "-",dez: "-", acumulado: "-" },
    { indicadores: "Nº de projetos - IEL", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: "-",dez: "-", acumulado: "" },
    { indicadores: "Nº de projetos - DCM", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: 2,dez: "-", acumulado: 2 },
    { indicadores: "Nº de projetos - CNI", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: "-",dez: 1, acumulado: 1 },
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <Typography variant="h4" gutterBottom>
        Setor: Coordenação de Inteligência de Mercado
      </Typography>
