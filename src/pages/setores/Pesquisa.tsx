...
const Pesquisa: React.FC = () => {
  ...
  const data = [
    { indicadores: "Número de pesquisas realizadas", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: 4,dez: 2, acumulado: 6 },
    { indicadores: "Tempo médio de realização das pesquisas", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: "-",dez: "-", acumulado: "-" },
    { indicadores: "Índice de Satisfação dos clientes por instituição", jan: "-", fev: "-", mar: "-", abr: "-", mai: "-", jun: "-", jul: "-", ago: "-", set: "-", out: "-", nov: 1,dez: "-", acumulado: 1},
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <Typography variant="h4" gutterBottom>
        Setor: Coordenação de Pesquisa de Mercado
      </Typography>
