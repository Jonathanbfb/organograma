...
const Sidebar: React.FC = () => (
  ...
  >
    ...
    {[
      { label: "Nº de clientes Industrial:", value: 1913 },
      { label: "Clientes visitados:", value: 178 },
      { label: "Propostas Realizadas:", value: 211 },
      { label: "Produtos existentes:", value: 1023 },
      { label: "Produtos Vendidos:", value: 118 },
    ].map((item, index) => (
      <div
        key={index}
        style={{
    ...
    <p style={{ margin: "0", padding: "0", fontSize: "15px",textAlign:"center" }} >Atualizado em 31/01/2025</p>
  </div>
);
