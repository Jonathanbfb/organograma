...
const Sidebar: React.FC = () => (
  ...
  >
    ...
    <p style={{ margin: "0", padding: "0", fontSize: "15px",textAlign:"center" }} >Atualizado em 29/01/2025</p>
  </div>
);
